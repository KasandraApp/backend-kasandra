import { check, date, integer, jsonb, numeric, pgEnum, pgTable, text, timestamp, uuid, varchar, } from 'drizzle-orm/pg-core';
...
export const inventoryMovements = pgTable('inventory_movements', {
    ...
    check('inventory_movements_type_check', sql `${table.movementType} IN ('in', 'out', 'adjustment')`),
